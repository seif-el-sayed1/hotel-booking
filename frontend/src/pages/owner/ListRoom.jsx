    ...
    return (
        <div className='w-4/5'>
            ...
            <div className='px-5 py-5'>
                ...
                <div className='w-full border w-full border-gray-200 rounded-xl overflow-x-auto hide-scrollbar md:overflow-hidden'>
                            ...
                            {roomsDummyData.map((ele, index) => {
                                return (
                                    <tr className='border-b-1 border-gray-200 text-gray-500' key={index}>
                                        ...
                                        <td className=' text-sm pl-5 py-3 text-wrap hidden md:block'>{ele.amenities.join(" || ")}</td>
