...
export const Recommended = () => {
    ...
    const filterHotels = async () => {
        const filteredHotels = allRooms.slice().filter((room) => {
            return searchHistory.includes(room.hotel.city)
        })
    ...
    return recommended.length > 0 && (
        <div className='pt-20 flex flex-col items-center justify-center bg-slate-50 ' >
            <div className='flex flex-col items-center justify-center pb-15'>
                <h1 className='font-light text-4xl mb-3'>Recommended Hotels</h1>
